...
public class PurchaseRestContoller {
	...
	@RequestMapping(value="json/addPurchaseViewAction/{prodNo}")
	public Product addPurchaseViewAction(@PathVariable String prodNo) throws Exception {
	...
	@RequestMapping(value="join/addPurchase")
